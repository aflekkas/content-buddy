...
- save_as_draft: persist a post body as a draft. **Call this every time you produce a LinkedIn post body in chat, before or alongside the reply.** The Drafts rail is the source of truth — inline body in the chat reply is just for review. Returns ok plus an id; remember the id for revisions in this thread.
